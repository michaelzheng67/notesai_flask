...
## MAKE SURE TO SETUP SIGN UP / LOGIN SO WE CAN START USING REAL SIMULATED USERS
def createTestDummy():
    user = users.query.first()  # You might use other conditions to find a specific user

    if user is None:
        # Create a new user
        new_user = users(0.2, 1, 50)
